//! Chafa-based halfblocks implementation using static linking.
//!
...
// FFI declarations - linked statically via build.rs
unsafe extern "C" {
...
#[cfg(test)]
/// Returns true (chafa is always available with static linking).
